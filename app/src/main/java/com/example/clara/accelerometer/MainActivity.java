...
//        musicLib.newSong(108,"zemmastyle__bart");
        ...
        musicLib.newSong(1000,"default__song");

//        musicLib.newSong(112,"revenge_wildstylez");
//        musicLib.newSong(124,"rhythm_is_a_dancer__snap");
//        musicLib.newSong(87,"umbrella__rihanna");
//        musicLib.newSong(85,"royals__lorde");
        musicLib.newSong(72,"rude__magic");
//        musicLib.newSong(101,"run_it__chris_brown");
//        musicLib.newSong(150,"scrap_attack__headhunterz");
//        musicLib.newSong(130,"beautiful_girls__sean_kingston");
//        musicLib.newSong(120,"sexual_eruption__snoop_dogg");
//        musicLib.newSong(75,"stitches__shawn_mendes");
//        musicLib.newSong(100,"sick_and_tired__anastacia");
//        musicLib.newSong(120,"sing__ed_sheeran");
//        musicLib.newSong(80,"this_afternoon__nickelback");
//        musicLib.newSong(105,"whine_and_kotch__charly_black");
//        musicLib.newSong(82,"wiggle__jason_derulo");
...
//    }
    ...
    public void differentBPM() {
        //toegevoegd zodat het vorige nummer wordt gestopt als differentbpm wordt aangeroepen. If statement zodat die niet errored als de mediaplayer nog niet geiniieerd is
        if(checkStart){
            mediaPlayer.stop();
            mediaPlayer.reset();
        }
        ...
        if(songList.size() > 0) {
            ...
            Toast.makeText(getApplicationContext(), "Your current pace has no matching song, default song is now played",Toast.LENGTH_LONG).show();
            songBPM = "999";
            songName = "default__song";
            playSound("default__song");
            displayPlayingSong();
        }
    }
...
//        }
    ...
    public void resetCount(View view) {
        ...
        currentlyPlaying.setText("No song yet selected");
